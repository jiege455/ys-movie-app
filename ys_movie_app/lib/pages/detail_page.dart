...
class _DetailPageState extends State<DetailPage> with TickerProviderStateMixin, WidgetsBindingObserver {
      ...
      errorBuilder: (context, errorMessage) {
        ...
        return Center(
          child: Column(
            ...
            children: [
              Icon(Icons.error_outline, color: scheme.primary, size: 42),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(backgroundColor: scheme.primary.withOpacity(0.24)),
      ...
      controlsConfiguration: BetterPlayerControlsConfiguration(
        ...
        customControlsBuilder: (controller, onVisibilityChanged) {
          return CustomPlayerControls(
            ...
            onMiniPlayerToggle: () {
              if (mounted) {
                setState(() => _miniPlayerActive = !_miniPlayerActive);
              }
            },
            onShowSources: () {
  ...
  Widget build(BuildContext context) {
    ...
    final subTextColor = scheme.onSurface.withOpacity(0.6);
    ...
    return Scaffold(
      ...
      body: TexturedBackground(
        ...
        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              _buildActionButton(
                                                ...
                                                label: '收藏',
                                                color: _isCollected ? scheme.error : subTextColor,
                                        ...
                                        children: List.generate(_sources.length, (i) {
                                          ...
                                          return Padding(
                                            ...
                                            child: ActionChip(
                                              ...
                                              labelStyle: TextStyle(color: isSel ? scheme.onPrimary : subTextColor),
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: bgColor,
                    boxShadow: [
                       BoxShadow(color: scheme.onSurface.withOpacity(0.05), offset: const Offset(0, -1), blurRadius: 10),
                    ],
                  ),
                  child: SafeArea(
                    child: Row(
          ...
          if (_miniPlayerActive) _buildMiniPlayer(bgColor, primaryColor),
        ],
        ),
      ),
    );
  ...
  Widget _buildMiniPlayer(Color bgColor, Color primaryColor) {
    return Positioned(
      left: 0,
      right: 0,
      bottom: 0,
      child: SafeArea(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: primaryColor.withOpacity(0.3), blurRadius: 12, offset: const Offset(0, -2)),
            ],
          ),
          child: Row(
            children: [
              ...
              IconButton(
                ...
                tooltip: _betterPlayerController?.isPlaying() == true ? '暂停' : '播放',
              ),
              IconButton(
              ...
              Container(
                ...
                child: Text(
                  "${detail['vod_name'] ?? ''} ${_episodes.isNotEmpty ? _episodes[_currentEpisodeIndex]['name'] : ''}",
                  overflow: TextOverflow.ellipsis,
              ...
              const SizedBox(width: 8),
              IconButton(
                icon: Icon(Icons.close, color: Colors.white.withOpacity(0.7), size: 24),
                onPressed: () {
  ...
  Widget _buildActionButton({
    ...
    return InkWell(
      ...
      child: Column(
        children: [
          Icon(icon, size: 24, color: color ?? subTextColor),
          const SizedBox(height: 4),
          Text(label, style: TextStyle(fontSize: 12, color: color ?? subTextColor)),
        ],
      ),
    );
  }
