    ...
    return (
      <div className="min-h-screen  flex items-center justify-center px-4">
        <div className="text-center">
          <p className="text-cyan-300 mb-4">请先登录</p>
          <button
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-cyan-100">{user?.user_name || '用户'}</h1>
                <p className="text-cyan-400/60 text-sm">ID: {user?.user_id || '-'}</p>
              </div>
            </div>
          </div>
        ...
        <div className="glass-card rounded-lg">
          ...
          <div className="p-4">
            {activeTab === 'favorites' ? (
              <div>
                {favorites.length === 0 ? (
                  <div className="text-center py-8">
                    <p className="text-cyan-400/60">暂无收藏</p>
                    <button
                      onClick={() => navigate('/')}
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {favorites.map((item: FavoriteItem) => (
                      ...
                      >
                        <div className="relative aspect-[2/3] rounded-lg overflow-hidden glass-light">
                          <img
                        ...
                        <p className="mt-1 text-sm text-cyan-200 truncate">{item.title}</p>
                      </div>
                    ))}
                  </div>
                )}
              ...
              <div className="text-center py-8">
                <p className="text-cyan-400/60">播放记录功能开发中...</p>
              </div>
            )}
          </div>
        </div>
