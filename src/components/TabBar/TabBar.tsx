...
export const TabBar: React.FC = () => {
  const itemCls = ({ isActive }: { isActive: boolean }) =>
    `flex flex-col items-center justify-center flex-1 py-2 ${isActive ? 'text-cyan-400' : 'text-cyan-400/50'}`
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 glass border-t border-cyan-500/20">
      <div className="flex">
